...
* *Meta Keywords*
* *Master Price*
* *Cost Price*: What the item cost to purchase or produce
...
* *Shipping Categories*: See [Shipping Categories](shipping_categories)
* *Tax Category*: See [Taxes Guide](configuring_taxes)
* *Taxons*: See [Taxonomies Guide](configuring_taxonomies)
* *Option Types*: Select any Options to associate a product with. See [Options Guide]
(product_options)
